...
| Build de référence | `npm run build` - `dist/` du 05/06/2026                         |
...
⚠️ **Chunk JS dépasse 500 kB** (519.25 kB minifié, 159.60 kB gzip) - acceptable en réseau haut débit. Piste : `React.lazy()` pour réduire le bundle initial.
...
## 1. Composition du bundle JS (519.25 kB minifié - build 05/06/2026)
